...
function moverForm(val){
    
    if(jQuery('#isMaster').length){
        
        return "<div>Sposta: <form method=\"POST\" action=\"service.php?fromCharts=do&coorArriveTo=" + val + '"> <span style="color: #0077c3;"> Coordinate <span style="color:white;"> | </span> X: </span><input type="text" name="coX" style="font-size:center; width:30px; " /> <span style="color: #0077c3;"> Y: </span><input type="text" name="coY" style="font-size:center; width:30px;" /> <input style="margin-top: 5px; margin-left:20px;" class="sendpadd" type="submit" value="ARRIVA" /></form></div>';
    }
    else return '';
}
