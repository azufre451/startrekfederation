...
else if(isSet($_GET['prest']))
{
		...
		$reiss = mysql_query("SELECT pgID,pgOffAvatarC,pgOffAvatarN,pgUser FROM pg_users WHERE pgOffAvatarC <> '' AND pgOffAvatarN <> '' AND (pgAuthOMA <> 'BAN' OR png=1) ORDER BY pgOffAvatarC");
		$pg = array();
