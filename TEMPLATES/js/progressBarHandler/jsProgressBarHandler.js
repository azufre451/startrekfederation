  ...
  */
 	...
 	// Default Options
		var defaultOptions = {
			...
			boxImage	: 'TEMPLATES/js/progressBarHandler/images/percentImage.png',			// boxImage : image around the progress bar
			barImage	: Array(
										'TEMPLATES/js/progressBarHandler/images/percentImage_back4.png',
										'TEMPLATES/js/progressBarHandler/images/percentImage_back3.png',
										'TEMPLATES/js/progressBarHandler/images/percentImage_back2.png',
										'TEMPLATES/js/progressBarHandler/images/percentImage_back1.png'
									),
