...
else if ($mode == 'sh' || ($mode == 'shM' && PG::mapPermissions('M',$currentUser->pgAuthOMA)))
{
	...
	if(mysql_affected_rows())
	{
		...
		if($place['placeType'] == 'Nave' && $place['placeSubType'] == 'ROMULAN') $template->labels = array('Scafo','Integrità Strutturale','Scudi Deflettori', 'Phaser e Siluri', 'Occultamento','Motori R.C.S.','Motori I.P.S.','Motori Warp','Comunicazioni','Sensori','Supporto Vitale','Teletrasporto');
		else if($place['placeType'] == 'Nave' && $place['placeSubType'] != 'ROMULAN') $template->labels = array('Scafo','Integrità Strutturale','Scudi Deflettori', 'Phaser e Siluri', 'Deflettore di Navigazione','Motori R.C.S.','Motori I.P.S.','Motori WARP','Comunicazioni','Sensori','Supporto Vitale','Teletrasporto');
