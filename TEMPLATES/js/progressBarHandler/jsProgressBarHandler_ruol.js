  ...
  */
 	...
 	// Default Options
		var defaultOptions = {
			...
			width		: 160,										// Width of the progressbar - don't forget to adjust your image too!!!
			boxImage	: 'TEMPLATES/js/progressBarHandler/images/bv_percentImage.png',			// boxImage : image around the progress bar
			barImage	: Array(
										'TEMPLATES/js/progressBarHandler/images/bv_percentImage_back1.png', 
										'TEMPLATES/js/progressBarHandler/images/bv_percentImage_back2.png',
										'TEMPLATES/js/progressBarHandler/images/bv_percentImage_back3.png'
									),
